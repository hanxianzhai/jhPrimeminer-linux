        ...
        void jhMiner_parseCommandline(int argc, char **argv)
        {
            ...
            while( cIdx < argc )
            {
                ...
                else if( memcmp(argument, "-m2", 3)==0 )
                {
                    ...
                    if( commandlineInput.primorialMultiplier2 < 5 || commandlineInput.primorialMultiplier2 > 1009)
                    {
                        cout << "-m2 parameter out of range, must be between 5 - 1009 and should be a prime number" << endl;
                        exit(0);
                    }
                    cIdx++;
                }
                else if( memcmp(argument, "-m3", 3)==0 )
                {
                    ...
                    if( commandlineInput.primorialMultiplier3 < 5 || commandlineInput.primorialMultiplier3 > 1009)
                    {
                        cout << "-m3 parameter out of range, must be between 5 - 1009 and should be a prime number" << endl;
                        exit(0);
                    }
                    cIdx++;
                }
                else if( memcmp(argument, "-m4", 3)==0 )
                {
                    ...
                    if( commandlineInput.primorialMultiplier4 < 5 || commandlineInput.primorialMultiplier4 > 1009)
                    {
                        cout << "-m4 parameter out of range, must be between 5 - 1009 and should be a prime number" << endl;
                        exit(0);
                    }
                    cIdx++;
                }
                    ...
                    while( true )
                    {
                        ...
                        if( workData.xptClient && xptWorkIdentifier != workData.xptClient->workDataCounter )
                        {
                            ...
                            if (workData.xptClient->blockWorkInfo.height > 0)
                            {
                                ...
                                std::cout << " [Mult "<< std::setw(4) << std::right << primeStats.nPrimorialMultiplier4 << "]" << std::endl;
...
//                                double statsPassedTime = (double)(getTimeMilliseconds() - primeStats.primeLastUpdate);
                                ...
                                if( workData.workEntry[0].dataIsValid )
                                {
                                    ...
                                    float shareValuePerHour = primeStats.fShareValue / totalRunTime * 3600000.0;
                                    std::cout << "==============================================================================" << std::endl;
                                    std::cout << "Val/h: " << shareValuePerHour << " - PPS: " << (sint32)primesPerSecond << " - SPS: " << sievesPerSecond << " - Last Block/Total: " << primeStats.fBlockShareValue << " / " << primeStats.fShareValue;
                                    std::cout << std::endl << "==============================================================================" << std::endl;
                                }
            ...
            int main(int argc, char **argv)
            {
                ...
                commandlineInput.primorialMultiplier = 37; // for default 0 we will switch auto tune on
                commandlineInput.primorialMultiplier2 = 41;
...
//                commandlineInput.primorialMulti = new int[4];
                ...
                if(commandlineInput.primorialMultiplier2 == 0) {
                    primeStats.nPrimorialMultiplier2 = 41;
                    bEnablenPrimorialMultiplierTuning = true;
                } else {
                    primeStats.nPrimorialMultiplier2 = commandlineInput.primorialMultiplier2;
                    bEnablenPrimorialMultiplierTuning = false;
                }
                if(commandlineInput.primorialMultiplier3 == 0) {
                    primeStats.nPrimorialMultiplier3 = 43;
                    bEnablenPrimorialMultiplierTuning = true;
                } else {
                    primeStats.nPrimorialMultiplier3 = commandlineInput.primorialMultiplier3;
                    bEnablenPrimorialMultiplierTuning = false;
                }
                if(commandlineInput.primorialMultiplier4 == 0) {
                    primeStats.nPrimorialMultiplier4 = 47;
                    bEnablenPrimorialMultiplierTuning = true;
                } else {
                    primeStats.nPrimorialMultiplier4 = commandlineInput.primorialMultiplier4;
                    bEnablenPrimorialMultiplierTuning = false;
                }
