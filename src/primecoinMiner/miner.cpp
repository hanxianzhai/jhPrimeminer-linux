...
//	const unsigned int nPrimorialMultiplierMax = 79;  unused?
    ...
    switch(threadIndex) {
        case 1:
            nPrimorialMultiplier = primeStats.nPrimorialMultiplier2;
            break;
        case 2:
            nPrimorialMultiplier = primeStats.nPrimorialMultiplier3;
            break;
        case 3:
            nPrimorialMultiplier = primeStats.nPrimorialMultiplier4;
            break;
        case 5:
            nPrimorialMultiplier = primeStats.nPrimorialMultiplier2;
            break;
...
//		uint64 nPrimeTimerStart = getTimeMilliseconds();   unused?
        ...
        //std::cout << "DEBUG: Th#:"<< threadIndex << "-Prim: "<<nPrimorialMultiplier << std::endl;
